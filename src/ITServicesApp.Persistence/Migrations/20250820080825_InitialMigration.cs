    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceIssues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceIssues_ServiceCategories_ServiceCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReminderJobId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_ServiceIssues_ServiceIssueId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechnicianSlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TechnicianSlots_Technicians_TechnicianId",
                        column: x => x.TechnicianId,
                        principalTable: "Technicians",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "TechnicianUnavailabilities",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechnicianUnavailabilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TechnicianUnavailabilities_Technicians_TechnicianId",
                        column: x => x.TechnicianId,
                        principalTable: "Technicians",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastWebhookEventId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechnicianReviews", x => x.Id);
                    table.CheckConstraint("CK_TechnicianReview_Rating_Range", "[Rating] BETWEEN 1 AND 5");
                    table.ForeignKey(
                        name: "FK_TechnicianReviews_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TechnicianReviews_Technicians_TechnicianId",
                        column: x => x.TechnicianId,
                        principalTable: "Technicians",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TechnicianReviews_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_EntityName_ChangedAtUtc",
                table: "AuditLogs",
                columns: new[] { "EntityName", "ChangedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ServiceIssueId",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceIssues_ServiceCategoryId_Name",
                table: "ServiceIssues",
                columns: new[] { "ServiceCategoryId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TechnicianReviews_BookingId",
                table: "TechnicianReviews",
                column: "BookingId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TechnicianReviews_TechnicianId_Rating",
                table: "TechnicianReviews",
                columns: new[] { "TechnicianId", "Rating" });

            migrationBuilder.CreateIndex(
                name: "IX_TechnicianReviews_TechnicianId_UserId",
                table: "TechnicianReviews",
                columns: new[] { "TechnicianId", "UserId" });

            migrationBuilder.CreateIndex(
                name: "IX_TechnicianReviews_UserId",
                table: "TechnicianReviews",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TechnicianSlots_TechnicianId_StartUtc_EndUtc",
                table: "TechnicianSlots",
                columns: new[] { "TechnicianId", "StartUtc", "EndUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_TechnicianUnavailabilities_TechnicianId_StartUtc_EndUtc",
                table: "TechnicianUnavailabilities",
                columns: new[] { "TechnicianId", "StartUtc", "EndUtc" });
